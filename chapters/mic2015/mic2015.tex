...
Additionally, the time required to train and test models can be contingent upon the choice of hyperparameters. Some hyperparameters have an obvious influence on train and/or test time, e.g. the architecture of neural networks \citep{bishop1995neural} and size of ensembles \citep{breiman2001random, ensemblesvm-jmlr}. The influence of hyperparameters can also be subtle, for instance regularization and kernel complexity can significantly affect training time for support vector machines \citep{bottou2007support}.
